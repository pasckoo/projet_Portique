...
<body onload="voirTdb()" background="../IMG/fonds/<?php echo $imageFond;?>.jpg">
    ...
    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
      ...
      <div class="nav-item dropdown dropstart" style="width:120px">
              ...
              <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                ...
                <li><a class="dropdown-item" href="#" data-toggle="modal" data-target="#modalFond">Changer l'image de fond</a></li>                 
                <li><hr class="dropdown-divider"></li>
                <li><a class="dropdown-item" href="#" data-toggle="modal" data-target="#disconnect"><img src="../IMG/signout.png"/> Déconnexion</a></li>
              </ul>
      </div>
    </nav>
  </div>
